...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container-page relative z-10 pb-8 pt-[calc(var(--header-stack-height)+0.85rem)] md:pb-16 md:pt-[calc(var(--header-stack-height)+1.5rem)] lg:pb-20 lg:pt-[calc(var(--header-stack-height)+1.75rem)]">
        <div className="max-w-5xl translate-y-2 md:translate-y-6 lg:max-w-[66rem] lg:translate-y-7 xl:translate-y-8">
          ...
          >
            ...
            {hasReviewMetrics ? (
              <>
                <span className="inline-flex items-center gap-[0.1rem] text-[0.78rem] leading-none text-[#f7d66b] drop-shadow-[0_1px_3px_rgba(4,14,38,0.65)] md:gap-[0.13rem] md:text-[0.94rem]" aria-hidden="true">
                  <span>★</span>
                  <span>★</span>
                  <span>★</span>
                  <span>★</span>
            ...
            <span className="inline-flex items-center text-[0.82rem] font-bold text-light-blue transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-pink md:text-[1rem]" aria-hidden="true">
              →
            </span>
          </a>
          <h1 className="mt-2.5 max-w-[12.4ch] font-sans text-[clamp(1.9rem,9.2vw,2.45rem)] font-black uppercase leading-[0.84] tracking-[-0.032em] md:max-w-[23ch] md:text-[clamp(2rem,5.2vw,4.25rem)] md:leading-[0.9] md:tracking-[-0.028em] lg:max-w-[20ch] lg:leading-[0.84] lg:tracking-[-0.032em]">
          ...
          <p className="mt-2 max-w-[35ch] text-[0.9rem] leading-[1.58] text-white/[0.9] md:mt-3 md:max-w-2xl md:text-[1rem] md:leading-relaxed">{hero.description}</p>

          <div className="mt-2.5 flex flex-col items-stretch gap-2.5 sm:flex-row sm:items-center md:mt-3.5 md:gap-3.5">
            <Link
