    ...
    <>
      ...
      <section className="relative container-page pb-16 pt-8 md:pb-24 md:pt-10">
        ...
        {isSouthAbilene ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              Best Fit for South Abilene Homeowners
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                This route is usually the best fit for homeowners who want a dependable service relationship instead of one-off help. If your priority is stable water, fewer equipment surprises, and clear communication after each visit, recurring weekly or bi-weekly care is typically the right starting point. We can also fold in filter service and targeted follow-up when your system needs extra attention. The goal is simple: keep your pool consistently swim-ready while protecting the equipment you already invested in.
              </p>
            </div>
          </section>
        ) : null}
        {isNorthAbilene ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              What North Abilene Homeowners Usually Want Help With First
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Most North Abilene conversations start with planning clarity: what condition the pool is in now, what maintenance steps should happen first, and what recurring cadence will keep things stable. Homeowners usually want dependable upkeep without guessing whether the system is drifting between visits. We help map immediate priorities, then align ongoing service around predictable route support, filter attention when indicators call for it, and practical communication after each visit. That gives you a clear maintenance path instead of reactive one-off decisions.
              </p>
            </div>
          </section>
        ) : null}
        {isAbileneWylie ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              A Practical Fit for Wylie Homeowners
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                This route is a strong fit if you want consistent maintenance without pretending pools never fall behind. We help homeowners keep regular service on track, and when water condition slips, we can shift into focused cleanup support before returning to normal recurring care. That balance keeps decisions simple: maintain stability when things are running well, correct quickly when they are not, and protect the pool system over time with clear communication at each step.
              </p>
            </div>
          </section>
        ) : null}
        {isBaird ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              How Baird Service Is Usually Confirmed
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Most Baird starts begin with route-fit confirmation, not instant scheduling promises. We first verify address alignment with active service windows, then review your pool condition to recommend the right opening step. Some homeowners are ready for recurring visits immediately, while others need one focused cleanup before ongoing care makes sense. This process keeps planning realistic and prevents mismatched expectations about timing. Once fit and condition are clear, we provide practical next steps and a dependable path forward.
              </p>
            </div>
          </section>
        ) : null}
        {isBuffaloGap ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              The Fastest Way to Confirm Buffalo Gap Timing
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Start by texting your address and a quick description of your pool condition. That single step lets us confirm coverage, check current openings, and recommend the right starting scope without delays. Some pools are ready for recurring visits right away, while others benefit from a one-time reset first. Either way, the process stays simple: fast confirmation, clear recommendation, and a defined plan you can act on. It is built to move quickly while still matching service to real pool needs.
              </p>
            </div>
          </section>
        ) : null}
        {isClyde ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              Why Clyde Is Best Served by Recurring Care
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Recurring maintenance is usually the most practical service model for Clyde pools because it keeps water balance, debris control, and system checks consistent week after week. That steady rhythm makes ownership simpler and reduces the need for reactive corrections. Specialty services still matter, but they work best as targeted support layered onto a stable recurring plan. Starting with dependable ongoing care gives homeowners clearer expectations, better long-term consistency, and a stronger baseline when extra service is needed.
              </p>
            </div>
          </section>
        ) : null}
        {isHamby ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              How Hamby Service Gets Scheduled
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                The fastest start is a text with your address and current pool condition. Once coverage is confirmed, we review what your pool needs and map the right starting scope, whether that is recurring service, a single-visit correction, or both in sequence. From there, we place service into the next available scheduling window and confirm clear next steps. The process is designed to stay simple, quick, and practical from first message to first visit.
              </p>
            </div>
          </section>
        ) : null}
        {isHawley ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              A More System-Focused Fit for Hawley Homeowners
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                This service path is built for homeowners who want maintenance decisions tied to system performance, not just appearance. We still handle core cleaning and water care, but we also track circulation behavior, filtration effectiveness, and early warning signs that can shorten equipment life if ignored. That system-first perspective helps prevent avoidable setbacks and supports more stable long-term pool operation. When concerns show up, recommendations are based on both water condition and equipment function so next steps are practical and targeted.
              </p>
            </div>
          </section>
        ) : null}
        {isMerkel ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              Why Recurring Plans Are Prioritized in Merkel
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Recurring plans are prioritized because consistent care usually delivers the strongest long-term pool stability. A steady cadence keeps chemistry control tighter and reduces stop-start maintenance patterns that often lead to repeated corrections. Specialty services still play an important role, but as strategic support when a pool needs a reset before recurring care can perform at its best. This approach keeps the focus on durable results: stabilize first, maintain consistently, and use specialty work only when it improves the long-term plan.
              </p>
            </div>
          </section>
        ) : null}
        {isPotosi ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              How to Get a Faster Recommendation in Potosi
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                The fastest path is to share useful detail first: address, photos, and a short note about current water condition. That lets us diagnose likely needs early and recommend the right starting service without unnecessary delays. Some pools are ready for recurring maintenance immediately, while others need cleanup or recovery first. By front-loading the right information, homeowners get clearer guidance, better first-step accuracy, and a smoother move from recommendation to scheduled service.
              </p>
            </div>
          </section>
        ) : null}
        {isTuscola ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              What Tuscola Onboarding Looks Like
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                Onboarding starts with a clear review of current pool condition and the most appropriate first step. If the pool is ready, we move directly into recurring service setup. If not, we handle any needed cleanup support first so ongoing care has a stable foundation. Once that starting path is defined, we confirm timing, set cadence expectations, and place your pool into the route with clear next steps. The goal is a smooth start that stays predictable from day one.
              </p>
            </div>
          </section>
        ) : null}
        {isTye ? (
          <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card md:p-8">
            <h2 className="font-sans text-[2rem] font-extrabold leading-[0.95] tracking-[-0.02em] text-navy md:text-[2.7rem]">
              How Tye Route Openings Are Confirmed
            </h2>
            <div className="mt-4 max-w-4xl text-sm leading-relaxed text-ink-muted md:text-base">
              <p>
                We begin with a quick fit check using your address and current pool condition, then compare that against active route availability. From there, you get a clear answer on whether recurring service can start now or if a different first step is more realistic. If openings are limited, we explain practical alternatives and timing expectations instead of leaving next steps vague. The process is designed to give homeowners a fast, direct path forward.
              </p>
            </div>
          </section>
        ) : null}
